...
To be approved as security review provider, please provide to us what is listed under [Requirements](#requirements). S.A.F.E. leadership will review your application. If we see potential, we will contact you to schedule a technical interview. If you are admitted you will have to join the OCP and pay the membership fee (if not already a member).
