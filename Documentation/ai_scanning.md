...
This requirement is mandatory for audits with a `completion_date` >= 2027-01-01. Prior to this date, this requirement is optional, but strongly recommended. This should give review providers and vendors time to set up suitable AI tools and processes.
